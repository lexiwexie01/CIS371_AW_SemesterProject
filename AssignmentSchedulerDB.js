...
class AssignmentSchedulerDB {
    ...
    static initialize() {
        this.db.serialize(() => {
            ...
            this.db.run('CREATE TABLE IF NOT EXISTS Users (uid INTEGER PRIMARY KEY, fname TEXT NOT NULL, lname TEXT NOT NULL, email TEXT NOT NULL, password TEXT NOT NULL, loggedIn);');
